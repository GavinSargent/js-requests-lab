...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/"Gavin"').then((result)=>{
...
const queryRequest = () => {
    axios.get('http://localhost:3000/query-test/?birthday=yesterday').then((result)=> {
        console.log(result.data)
    })
}
...
//     const foodInput = document.querySelector("#food1")
//     const body = { newFood: foodInput.value }
//     axios.post('http://localhost:3000/food', body).then((result)=>{
//     console.log(result.data)
//     let li = document.createElement('li')
//     li.innerText = result.data
//     foodInput.uppendChild(li)
//     // let foodArr = []
//     // foodArr.textContent = result.data
//     // li.uppendChild(foodArr)
//     // foodList.uppendChild(li)
//     // foodList.style.display = "block"
//     })
//     }

// foodList.addEventListener("submit", createFood)
